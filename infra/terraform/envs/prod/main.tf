...
#   - Zone → DNS → Edit  on the compliance-atoms.com zone
...
module "pages_project" {
  ...
  project_name          = "compliance-atoms"
  production_branch     = "main"
  custom_domain         = "compliance-atoms.com"
  zone_id               = var.zone_id
}
...
variable "zone_id" {
  description = "Cloudflare zone ID for compliance-atoms.com."
  type        = string
}
